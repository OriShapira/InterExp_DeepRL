...
def data_loader_collate(batch):
    id_batch, topicId_batch, docs_batch, refs_batch, initial_batch, refkps_batch = unzip(batch)
    ...
    return all_docs_sents, all_refs_sents, list(id_batch), list(topicId_batch), list(initial_batch), list(refkps_batch)
